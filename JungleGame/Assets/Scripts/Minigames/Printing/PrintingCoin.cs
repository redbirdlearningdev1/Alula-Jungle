...
public class PrintingCoin : MonoBehaviour
{
    ...
    private Vector3 scaleSmall = new Vector3(.10f, .10f, 0f);
    ...
    {
        shrink();
        StartCoroutine(moveInRoutine(chestPos));
    }
    ...
    public void SetCoinTypeSuccess(ActionWordEnum type)
    {
        this.type = type;
        // get animator if null
        if (!animator)
